...
import { Heart, Gift, Star, ShoppingBag } from "lucide-react";
  ...
  return (
    <PublicLayout>
        ...
        <div className="container mx-auto px-4 relative z-10 text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-serif font-bold text-foreground mb-6">
              Indulge in <span className="text-primary italic">Every Moment</span>
            </h1>
      ...
      <section className="py-24 bg-card">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              { icon: ShoppingBag, title: "Imported Selection", desc: "Carefully curated premium chocolates from around the world." },
              { icon: Gift, title: "Floral Arrangements", desc: "Beautiful bouquets paired perfectly with your sweet gifts." },
              { icon: Heart, title: "Friendly Service", desc: "A warm, boutique experience with personalized attention." }
            ].map((feature, i) => (
              <motion.div 
                key={i}
      ...
      <section className="py-24">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-12">
            <div>
              <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground mb-4">Featured Collection</h2>
            ...
            {isLoadingProducts ? (
              ...
              >
                <div className="aspect-[4/3] overflow-hidden relative">
                  ...
                  />
                  <div className="absolute top-4 left-4 bg-background/90 backdrop-blur-sm px-3 py-1 text-xs font-medium rounded-full text-primary">
                    {product.category}
                  </div>
                </div>
                <div className="p-6">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <span className="text-primary font-semibold">{product.price} AED</span>
                  </div>
      ...
      <section className="py-24 bg-card">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-serif font-bold text-foreground mb-4">Sweet Words</h2>
            <div className="w-24 h-1 bg-primary mx-auto"></div>
          </div>
